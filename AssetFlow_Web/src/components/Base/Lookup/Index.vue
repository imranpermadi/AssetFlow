    ...
    <Card>
        ...
        <template #content>            
            <DataTable ref="dt" responsiveLayout="scroll" class="p-datatable-sm" filterDisplay="row" sortMode="multiple" removableSort
                ...
                <Column field="LookupGroup" :header="$t('lookup_group')" :sortable="true">
                ...
                <Column field="LookupKey" :header="$t('lookup_key')" :sortable="true">
                    <template #filter="{filterModel,filterCallback}">
                ...
                <Column field="LookupValue" :header="$t('lookup_value')" :sortable="true">
                    <template #filter="{filterModel,filterCallback}">
                ...
                <Column field="LookupInfo1" :header="$t('lookup_info1')" :sortable="true">
                    <template #filter="{filterModel,filterCallback}">
                ...
                <Column field="LookupInfo2" :header="$t('lookup_info2')" :sortable="true">
                    <template #filter="{filterModel,filterCallback}">
